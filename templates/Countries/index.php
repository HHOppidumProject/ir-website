        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th><?= $this->Paginator->sort('COUNTRYNAME') ?></th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="actions">
                        <?= $this->Html->link(__('View'), ['action' => 'view', $country->COUNTRYID]) ?>
                        <?= $this->Html->link(__('Edit'), ['action' => 'edit', $country->COUNTRYID]) ?>
                        <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $country->COUNTRYID], ['confirm' => __('Are you sure you want to delete # {0}?', $country->COUNTRYID)]) ?>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
