...
<section id="highlights" class="wrapper style3">
    ...
    <div class="hero is-widescreen has-text-centered" style="background-image:url(/img/venus.jpg); background-size: cover; height:75vh;">

        <h2 class="subtitle is-1" style="color:var(--brand-color)">Goddess of Love</h2>
    </div>
